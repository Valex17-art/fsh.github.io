    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./">FSH <sup><small><span class="label label-info">♦</span></small></sup> </a>
        </div>
...
?>
         <ul class="nav navbar-nav">
          <li><a href="index.php?view=newreservation"><i class="fa fa-asterisk"></i> Nuevo Agendamiento</a></li>
          </ul> 
          <ul class="nav navbar-nav side-nav">
          <li><a href="index.php?view=home"><i class="fa fa-home"></i> Inicio</a></li>
          <li><a href="index.php?view=reservations"><i class="fa fa-calendar"></i> Agendamiento</a></li>
          <li><a href="index.php?view=projects"><i class="fa fa-flask"></i> Servicios</a></li>
          <li><a href="index.php?view=categories"><i class="fa fa-th-list"></i> Categorias</a></li>
          <?php if($u->is_admin):?>
          <li><a href="index.php?view=changelog"><i class="fa fa-info"></i> Info </a></li>
